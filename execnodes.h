...
typedef struct NestLoopState
{
	...
	bool		nl_MatchedOuter;
    	...
    	/* these fields are used for bucket-nested loop join */
    	List **buckets;  /* array of lists to store inner tuples */
   	 List *currentBucket;  /* current bucket being processed */
    	ListCell *currentBucketPosition;  /* current position in the current bucket */

	TupleTableSlot *nl_NullInnerTupleSlot;/* slot for null inner tuples */

    	/* to handle the parameters from outer side to inner side */
    	List *nestParams;  /* List of NestLoopParam nodes */

    	ProjectionInfo *projInfo; /* info for result projection */
} NestLoopState;
